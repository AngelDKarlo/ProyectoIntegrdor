...
Q_CONSTINIT static const qt_meta_stringdata_LoginWindow_t qt_meta_stringdata_LoginWindow = {
    {
        ...
        QT_MOC_LITERAL(12, 15),  // "mostrarRegistro"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 12),  // "loginExitoso"
        QT_MOC_LITERAL(42, 5),  // "apodo"
        QT_MOC_LITERAL(48, 13),  // "intentarLogin"
        QT_MOC_LITERAL(62, 11)   // "irARegistro"
    },
    "LoginWindow",
    "mostrarRegistro",
    "",
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->mostrarRegistro(); break;
        case 1: _t->loginExitoso((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->intentarLogin(); break;
        case 3: _t->irARegistro(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginWindow::mostrarRegistro; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &LoginWindow::loginExitoso; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void LoginWindow::loginExitoso(const QString & _t1)
{
